...
Open http://127.0.0.1:4179 in Chrome. The page runs eight checks against the actual
React components and DOM code. A successful run changes the title to
`PASS MFA regression` and displays eight `PASS` lines. Results are also available
